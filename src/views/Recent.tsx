      ...
      <div className="flex justify-between items-center mb-6">
        ...
        {recentArticles.length > 0 && (
          <button 
            ...
            className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-brand-error bg-brand-error/10 hover:bg-brand-error/20 rounded-lg transition-colors"
          >
            <Trash2 size={16} />
            Clear History
          </button>
                ...
                <div className="p-5 flex flex-col flex-1 relative z-10">
                  ...
                  <div className="mt-auto flex items-center justify-between border-t border-brand-outline-variant pt-3 mt-4">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs font-medium text-gray-700">A. Volkov</span>
                    </div>
                    <div className="flex items-center gap-2">
